...
//  
//  if(any(is_na(upper_))){
//      const arma::vec u = Ym.elem(arma::find(arma::trimatl(Ym)));
//      const arma::vec l = Ym.elem(arma::find(arma::trimatu(Ym)));
////      u.print("upper matrix");
////      l.print("lower matrix");
//      
//      arma::uvec t = arma::find(arma::trimatu(Ym));
//      t.print("upper indices");
//      
//      arma::uvec q = arma::find(arma::trimatl(Ym));
//      q.print("lower indices");
//      
//      bool upper = all(u==0);
//      bool lower = all(l==0);
//      
